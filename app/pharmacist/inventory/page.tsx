            ...
            <div key={item.id} className="card">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  {item.drug.genericName && <p className="text-sm text-gray-600 mt-1">{item.drug.genericName}</p>}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`font-medium ${
                      item.stock > 10 ? 'text-success-600' : item.stock > 0 ? 'text-yellow-600' : 'text-danger-600'
                    }`}
                  >
                    {item.stock} units
                  </span>
              ...
              <div className="flex items-center space-x-2 pt-4 border-t border-gray-200">
                <Button variant="outline" onClick={() => openEditModal(item)} className="flex-1">
                  <Edit className="h-4 w-4 mr-2" />
                  Edit
                </Button>
                <Button variant="danger" onClick={() => handleDeleteDrug(item.id)}>
